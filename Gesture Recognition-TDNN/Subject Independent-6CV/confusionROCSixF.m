...
saveas(figure(1), [pwd '\ROC\6CV\Fold1ROC.fig']);
ezroc3( predictT2_4by4 );
saveas(figure(2), [pwd '\ROC\6CV\Fold2ROC.fig']);
ezroc3( predictT3_4by4 );
saveas(figure(3), [pwd '\ROC\6CV\Fold3ROC.fig']);
ezroc3( predictT4_4by4 );
saveas(figure(4), [pwd '\ROC\6CV\Fold4ROC.fig']);
ezroc3( predictT5_4by4 );
saveas(figure(5), [pwd '\ROC\6CV\Fold5ROC.fig']);
ezroc3( predictT6_4by4 );
saveas(figure(6), [pwd '\ROC\6CV\Fold6ROC.fig']);
ezroc3( overall );
saveas(figure(7), [pwd '\ROC\6CV\OverallROC.fig']);
...
% Save the matrix
saveas(confusionG, [pwd '\ROC\6CV\Confusion.fig'])
end