...
% Test 1
netc1 = closeloop(f1net);
predictTestT1_pack = netc1(f1Test);
...
% Test 2
netc2 = closeloop(f2net);
predictTestT2_pack= netc2(f2Test);
...
% Test 3
netc3 = closeloop(f3net);
predictTestT3_pack = netc3(f3Test);
...
% Test 4
netc4 = closeloop(f4net);
predictTestT4_pack = netc4(f4Test);
...
% Test 5
netc5 = closeloop(f5net);
predictTestT5_pack = netc5(f5Test);
...
% Test 6
netc6 = closeloop(trained6CVnet);
predictTestT6_pack = netc6(f6Test);
