...
[trained3CVnet_P1, predictTestT1_P1, predictTestT2_P1, predictTest_P1, stackMovementTest_P1] = threeFoldCV(TDNNnet, P1_C, P1_T, P1_R, P1_D);
[trained3CVnet_P2, predictTestT1_P2, predictTestT2_P2, predictTest_P2, stackMovementTest_P2] = threeFoldCV(TDNNnet, P2_C, P2_T, P2_R, P2_D);
[trained3CVnet_P3, predictTestT1_P3, predictTestT2_P3, predictTest_P3, stackMovementTest_P3] = threeFoldCV(TDNNnet, P3_C, P3_T, P3_R, P3_D);
[trained3CVnet_P4, predictTestT1_P4, predictTestT2_P4, predictTest_P4, stackMovementTest_P4] = threeFoldCV(TDNNnet, P4_C, P4_T, P4_R, P4_D);
