...
[trained3CVnet, predictTestT1, predictTestT2, predictTestT3, stackMovementTest] = threeFoldCV(TDNNnet, P1_C, P1_T, P1_R, P1_D);

% Plot ROC for CV1, CV2, CV3 and overall CV + save all graphs
confusionROC('Person1', predictTestT1, predictTestT2, predictTestT3);