function [autoenc1, feature1, autoenc2, feature2, predictTest, predictTest_DN ] = autoEncoderModel(trainData, train_T, testData, test_T)
...
% Fine Tune the Model 
xTrain = zeros(inputSize,numel(trainData));
